...
\usepackage{graphicx,subfiles,tocbibind,amsmath,array,url,pdflscape, float}
...
%***************************************************
\setlength{\parindent}{5ex} %will be indented 10ex (an "ex" equals the length of the "x" in the current font)
...
\subfile{sections/main/lit_review}
\subfile{sections/main/methods}
\subfile{sections/main/results}
\subfile{sections/main/discussion}
